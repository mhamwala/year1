...
public class CircularLinkedList {
    ...
    /**
     * Stores the first node in the list. In this case this node is always a
     * dummy node with a sentinel value of 999.
     */
    ListNode head;
    int size = 0;
    ...
    /**
     * Returns the 1-based index of the first node in the list containing the
     * specified value.
     *
     * @param value the value to search for
     * @return the 1-based index of the first node in the list containing the
     * specified value
     */
