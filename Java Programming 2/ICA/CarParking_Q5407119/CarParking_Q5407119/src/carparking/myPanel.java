...
public class myPanel extends JPanel implements ActionListener, MouseListener
{
    ...
    public void currentTotal()
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            if (lorryList[i] != null)
            {
                total = total + lorryList[i].charge;
            }
        }
        for (int i = 0; i < 4; i++)
        {
            if (coachList[i] != null)
            {
                total = total + coachList[i].charge;
            }
        }
    }
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "overallTotal " + overallTotal);
        }
        if (e.getSource() == Save)
        {
            try
            ...
            {
                System.out.println("error gutting");
            }
        }
    ...
    public void mouseClicked(MouseEvent e)
    {
        ...
        if (button == 1)
        {
            ...
            //JOptionPane.showMessageDialog(null, "Disabled badge: ");
            for (int i = 0; i < 12; i++)
            {
                if (e.getSource() == cars[i])
                {
                    ...
                    double d = carList[i].charge;

                    if (a == true)
                    {
                        JOptionPane.showMessageDialog(null, "Detials for car in parking space: " + i + 1 + "\n\nDisabled badge: " + "Yes" + "\nLength: " + b + "\nNum of Hours: " + c + "\nCharge: " + d);
                    }
                    else
                    {
                        JOptionPane.showMessageDialog(null, "Detials for car in parking space: " + i + 1 + "\n\nDisabled badge: " + "No" + "\nLength: " + b + "\nNum of Hours: " + c + "\nCharge: " + d);
            ...
            for (int i = 0; i < 4; i++)
            {
                if (e.getSource() == lorries[i])
                {
                    if (lorryList[i] != null)
                    {
                        ...
                        double c = lorryList[i].charge;
                        JOptionPane.showMessageDialog(null, "Detials for car in parking space: " + i + 1 + "\n\nweight: " + a + "\nnum of days: " + b + "\ncharge: " + c);

                    }
                    else if (coachList[i] != null)
                    {
                        JOptionPane.showMessageDialog(null, "num of passenger" + coachList[i].numOfPassengers + "\n charge : " + coachList[i].charge);
                    }
                }
            }
